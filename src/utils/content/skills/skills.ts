...
const skills: CompetenciesStructure[] = [
  {
  ...
  },
  {
    ...
    description:
      "With a great ability to quickly grasp concepts, I am always on the lookout for opportunities to expand my knowledge and adapt to emerging technologies.",
  },
  {
